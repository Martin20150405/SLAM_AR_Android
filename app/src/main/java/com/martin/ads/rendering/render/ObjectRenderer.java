...
public class ObjectRenderer {
  ...
  public void createOnGlThread(Context context, String objAssetName, String diffuseTextureAssetName)
    ...
    ShaderUtils.checkGLError(TAG, "OBJ buffer load");

    final int vertexShader =
        ShaderUtils.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, R.raw.object_vertex);
    final int fragmentShader =
        ShaderUtils.loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, R.raw.object_fragment);
  ...
  public void draw(float[] cameraView, float[] cameraPerspective, float lightIntensity) {
    ...
    ShaderUtils.checkGLError(TAG, "After draw");
  }
